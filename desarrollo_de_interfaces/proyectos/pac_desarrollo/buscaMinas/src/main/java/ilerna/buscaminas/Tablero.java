...
public class Tablero extends javax.swing.JFrame {
    ...
    private boolean funcionesAsignadas;

    /**
     * Creates new form Tablero
     */
    public Tablero() {
        funcionesAsignadas = false;
        initComponents();
    ...
    private void asignarFuncionBotones() {
        /* TODO */
        if (funcionesAsignadas)
            return;
        for (int i = 0; i < FILAS; i++) {
            for (int j = 0; j < COLUMNAS; j++) {
                final int ii = i; // Necesario para usar en el listener anónimo
                final int jj = j;
                // Agrega el listener
    ...
    private void btnNuevaPartidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevaPartidaActionPerformed
        // Resetear el juego para poder volver a empezar sin problema
        this.resetearJuego();
